<template>
  <div class="container">
    ...
    <ul class="social flex">
      <li>
        <a
          href="https://api.whatsapp.com/send/?phone=5527988170270&text=Olá"
          target="blank"
          class="whats"
        >
          <svg
      ...
      <li>
        <a
          href="https://www.linkedin.com/in/venturimdias/"
          target="blank"
          class="link"
        >
          <svg
          ...
          >
            <g id="in">
              <path
                d="M21.6,21.1h4.7v2.4l0,0c0.7-1.2,2.3-2.4,4.7-2.4c5,0,5.5,2.9,5.5,7.1v8.7h-4.7v-7.9   c0-1.8,0.1-3.9-2.4-3.9c-3.2,0-3.2,1.9-3.2,3.9v7.9h-4.7L21.6,21.1L21.6,21.1z"
                fill="#0E76A8"
                id="n_1_"
              />
              <rect
      ...
      <li>
        <a
          href="https://www.instagram.com/venturimdias/"
          target="blank"
          class="insta"
        >
          <svg
      ...
      <li>
        <a
          href="https://www.facebook.com/venturim.dias"
          target="blank"
          class="face"
        >
          <svg
